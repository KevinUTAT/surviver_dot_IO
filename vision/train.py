'''
The following implimentation of yolov3 is from Ultralytics LLC at
https://github.com/roboflow-ai/yolov3
Therefore holds the original copyright of the implimentation.
Small modification is made to fit different environment.
The follwing implimentation is under GPL 3.0
'''
...
if __name__ == '__main__':
    ...
    parser.add_argument('--img-size', nargs='+', type=int, default=[1024], help='train and test image-sizes')
    ...
    parser.add_argument('--weights', type=str, default='config/yolov3-spp-ultralytics.pt', help='initial weights path')
