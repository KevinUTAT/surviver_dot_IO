...
def plot_one_box(x, im, color=(128, 128, 128), label=None, \
        track_id=None, line_thickness=3, speed=None, velo_x=None, velo_y=None):
    ...
    if label:
        ...
        if velo_x and velo_y:
            ...
            # print(start, end)
            im = cv2.arrowedLine(im, start, end, color, thickness=2*tf, line_type=cv2.LINE_AA)
